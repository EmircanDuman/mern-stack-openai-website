...
const CreatePost = () => {
  ...
  //this will allow us to go back to the homepage once the post is created
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">Create imaginative
        and visually stunning images through DALL-E AI and share them with the community</p>
      </div>
      <form className="mt-16 maxw3x4" onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          ...
          text-sm rounded-lg focus:ring-blue-500 w-64 p-3
